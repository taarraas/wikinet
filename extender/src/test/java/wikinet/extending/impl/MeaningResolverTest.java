...
import wikinet.extending.MeaningResolver;

/**
 * @author taras
 */
public class MeaningResolverTest extends TestCase {

    public MeaningResolverTest(String testName) {
        super(testName);
    }
    ...
    protected void setUp() throws Exception {
        super.setUp();
        meaningResolver = new MeaningResolver();
    }
    ...
    public void testGetMainWordObahma() {
        ...
        Map<String, String> result = meaningResolver.getInfo(text);
        Assert.assertEquals(expResult, result.get(MeaningResolver.MAINWORD));
        //assertEquals(of, result.get(MeaningResolver.PARTOF));
    }
    ...
    public void testGetMainWordLandform() {
        ...
        System.out.println(expResult);
        Map<String, String> result = meaningResolver.getInfo(text);
        //assertEquals(expResult, result.get(MeaningResolver.MAINWORD));
    }
