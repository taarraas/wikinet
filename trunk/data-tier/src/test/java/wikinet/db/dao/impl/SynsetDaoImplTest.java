...
public class SynsetDaoImplTest extends SpringDaoTest {
    ...
    public void testSave() {
        ...
        wordDao.save(word2);
        Synset synset = new Synset(1L, "desc", SynsetType.NOUN);
        synset.addWord(word);
    ...
    public void testSaveWithIdAutoGenerated() {
        Synset synset = new Synset("desc", SynsetType.NOUN);
        synsetDao.save(synset);
        synset = new Synset("desc", SynsetType.NOUN);
        synsetDao.save(synset);
    ...
    public void testMultipleSaveWithWordOrderCheck() {
        ...
        synset.addWord(word2);
        synsetDao.save(synset);
        Synset synset2 = new Synset(2L, "desc", SynsetType.NOUN);
